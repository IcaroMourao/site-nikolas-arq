...
export default class ProjectsItems {
  static projects = [
    ...
    },
    {
      ...
      shortDescription: '<p>Ambientes funcionais e integrados são a nova tendência em casas e principalmente apartamentos. Assim como os home offices que estão cada vez mais comuns devido a tecnologia e a diversos trabalhos que dependem dela.</p>',
      id: 'office-in-house',
      architect: 'Nikolas Mourão',
      area: '38,5',
      year: 2020,
    ...
    },
    {
      ...
      shortDescription: '<p>A seleção do mobiliário e a presença da madeira clara e rattan em todo o ambiente, com acabamento de filetes metalizados e no piso, além das lâminas de madeira, as paredes também foram revestidas com ripas de madeiras claras.</p>',
      id: 'suite-rotang',
      architect: 'Nikolas Mourão',
      area: '45',
      year: 2020,
    ...
    },
    {
      ...
      img: require('@/assets/images/projects/project4/04.jpg'),
      ...
      shortDescription: '<p>Um verdadeiro santuário de relaxamento, com materiais naturais como pedra e madeira proporcionam um equilíbrio minimalista e aconchegante.</p>',
      id: 'santuario-natural',
      architect: 'Nikolas Mourão',
      area: '15,35',
      year: 2020,
      local: 'Brasília/DF',
      ...
      sliderImgs: [
        {
          name: '01',
          img: require('@/assets/images/projects/project4/01.jpg'),
        },
        {
          name: '02',
          img: require('@/assets/images/projects/project4/02.jpg'),
        },
        {
          name: '03',
          img: require('@/assets/images/projects/project4/03.jpg'),
        },
        {
          name: '04',
          img: require('@/assets/images/projects/project4/04.jpg'),
        ...
        {
          name: '05',
          img: require('@/assets/images/projects/project4/05.jpg'),
        },
      ],
    },
    {
      name: 'Residencial Primavera',
      img: require('@/assets/images/projects/project5/04.jpg'),
      description: '<p>Com um bom projeto, é possível viver em um ambiente aconchegante, com tudo o que você precisa. Com aproximadamente 20m² conseguimos atender a todas as exigências do cliente com uma paleta de tons suaves e neutros e acabamentos práticos com excelente custo-benefício. Integração total e um bom projeto de marcenaria são os dois ingredientes principais da receita de sucesso que fez o espaço ser melhor aproveitado.</p>',
      id: 'residencial-primavera',
      architect: 'Nikolas Mourão',
      area: '19,20',
      year: 2020,
      local: 'Fortaleza/CE',
      ...
      sliderImgs: [
        {
          name: '01',
          img: require('@/assets/images/projects/project5/01.jpg'),
        },
        {
          name: '02',
          img: require('@/assets/images/projects/project5/02.jpg'),
        },
        {
          name: '03',
          img: require('@/assets/images/projects/project5/03.jpg'),
        },
        {
          name: '04',
          img: require('@/assets/images/projects/project5/04.jpg'),
        ...
        {
          name: '05',
          img: require('@/assets/images/projects/project5/05.jpg'),
        },
        {
          name: '06',
          img: require('@/assets/images/projects/project5/06.jpg'),
        },
        {
          name: '07',
